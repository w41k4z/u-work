            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form class="forms-sample">
                        ...
                        <button class="btn btn-light">Terminer</button>
                    </form>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form class="forms-sample">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="exampleInputEmail2" placeholder="Prix du Régime par jour">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Durée</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="exampleInputMobile" placeholder="Durée du régime">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Poid</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="exampleInputPassword2" placeholder="Poid à perdre">
                        </div>
                        </div>
